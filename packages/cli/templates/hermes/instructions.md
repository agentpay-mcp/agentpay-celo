...
Use AgentPay MCP tools when the user wants to create an AgentPay wallet, check balance, prepare a stablecoin payment, swap, bridge, pay across chains, execute after exact approval, or track payment status.
