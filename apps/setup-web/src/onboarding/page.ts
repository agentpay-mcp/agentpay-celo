...
<body>
  <main>
    <div class="eyebrow">Celo mainnet · chain 42220</div>
    ...
    <div class="safe"><span class="dot"></span><span>Canonical USDC only · no route targets · no wallet private key requested</span></div>
    <dl id="details" hidden>
      <dt>Owner</dt><dd id="owner">—</dd>
      <dt>Chain</dt><dd id="chain">42220</dd>
